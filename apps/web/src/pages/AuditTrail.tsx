  ...
  return (
    <div className="mx-auto flex min-h-full max-w-[1680px] flex-col gap-6 p-4 sm:p-6 lg:p-8">
      <PageHeader
        ...
        description="Every risk decision, escalation, and recommendation is timestamped, model-routed, confidence-scored, and exportable for internal review."
        action={
          <a
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <FilterField label="Agent" value={agent} onChange={setAgent} placeholder="Risk Detection Engine" />
        <FilterField label="District" value={district} onChange={setDistrict} placeholder="Search any district" />
